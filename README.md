...
## About Data
The dataset for this project is attained from Kaggle which contains the data sourced from a survey conducted by airlines on the satisfaction level of passengers/customers based on various factors. The dataset consists of twenty five columns such as Age, Gender, Travel class, Arrival and Departure delays and also features that affects customer satisfaction such as On-board service, Cleanliness, Baggage handling etc. <br/>
